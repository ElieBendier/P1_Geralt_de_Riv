            ...
            <div class="global-zone-text">
                ...
                <div class="section-text">
                    <ul>
                        ...
                        <br>
                        <li> My base of operations is <span>Kaer Morhen</span> : a secre    t and luxurious den hidden in the myst of the highest mountains of the northen kingdom of Kaedwen.</li>
                        <br>
    ...
    <section class="section-bloc" id="graveyard">
        ...
        <div class="bloc-2">
            <div class="global-zone-text">
                ...
                <div class="section-text">
                    <p>
                        Here are some of my famous exploits
                    </p>
